...
import { EmailIcon, PasskeyIcon } from '@/components/shared/icons';
import { useAuth, useAuthForm } from '@/lib/hooks';
...
export default function LoginForm({ email, setEmail }: LoginFormProps) {
    const {
        isLoading,
        error,
        clearError,
